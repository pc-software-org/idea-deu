...
class CliEndToEndTests(unittest.TestCase):
    ...
    def _write_archive(self, properties: bytes, *, include_tip: bool):
        ...
        product = json.dumps({"version":"2026.2.2","buildNumber":"262.10315.125","productCode":"IU"})
        ...
        config = {"archive":"idea.zip","version":"2026.2.2","build_number":"262.10315.125",
            "product_code":"IU","sha256":hashlib.sha256(self.archive.read_bytes()).hexdigest(),
            "since_build":"262.10315.125","until_build":"262.10315.125",
            "plugin_id":"org.pc-software.idea-deu","plugin_version":"2026.2.2.1"}
    ...
    def test_real_cli_command_sequence_reaches_complete_package(self):
        ...
        self.assertEqual(DOMAIN_ERROR, code); self.assertIn("2026.2.2.1", stderr)
